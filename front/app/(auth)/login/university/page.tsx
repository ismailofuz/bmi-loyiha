...
export default function UniversityLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const data = await api.post<{ access_token: string }>("/auth/login", {
        email, password, role: "university_staff",
      });
  ...
  return (
    <div className="flex w-full min-h-screen">
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-[#065f46] px-12 py-10 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <h2 className="text-3xl font-bold text-white leading-snug">Ta'lim muassasasi kabineti</h2>
          <p className="text-emerald-200 text-sm leading-relaxed max-w-xs">
            Talabalar amaliyotini boshqaring, shartnomalar tuzing va hodimlarni nazorat qiling.
          </p>
        </div>
        <p className="relative z-10 text-emerald-300 text-xs">© 2026 Amaliyot Tizimi</p>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Ta'lim muassasasi tizimiga kirish</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              ...
              <input type="email" required value={email} onChange={e => setEmail(e.target.value)}
                ...
                className="block w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm outline-none focus:border-[#059669] focus:ring-2 focus:ring-[#059669]/10" />
            </div>
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} required value={password}
                  ...
                  className="block w-full rounded-xl border border-gray-300 px-4 py-2.5 pr-11 text-sm outline-none focus:border-[#059669] focus:ring-2 focus:ring-[#059669]/10" />
            ...
            <button type="submit" disabled={loading}
              className="mt-2 w-full rounded-xl bg-[#059669] py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-60 transition-colors">
